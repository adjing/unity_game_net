...
public class HttpLog
{
    ...
    /// 游戏APP唯一ID
    /// </summary>
    public static string m_game_guid = "game_liquanqing";
    ...
    public static void Save(string debug_type, string game_log, Action<string> on_success=null, Action<string> on_error=null)
    {
